...
Group.hasMany(GroupsUsers, { as: "GroupsUsers", foreignKey: "GroupId" });
GroupsUsers.belongsTo(Group, { foreignKey: "GroupId" });
...
async function getUserGroups(id,res) {
  try {
    return await Group.findAll({
      include: [{ model: GroupsUsers, as: "GroupsUsers" }],
      where:{
...
export { deleteGroup, getByIdGroup, getAllGroups, updateGroup, createGroup,getUserGroups };
